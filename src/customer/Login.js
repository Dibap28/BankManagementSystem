    ...
    return ( <React.Fragment>
      ...
      <Form>
        ...
        <Form.Group className="Registration-flex fullwidth" controlId="formBasicEmail">
          ...
          <Form.Control className="halfwidth" type="email" placeholder="Enter email" onChange={setEmail}/>
        </Form.Group>
        </Form.Row>
        <Form.Row className="unset-margin">
        <Form.Group className="Registration-flex fullwidth" controlId="formBasicPassword">
          ...
          <Form.Control className="halfwidth" type="password" placeholder="Password" onChange={setPassword}/>
        </Form.Group>
        </Form.Row>
